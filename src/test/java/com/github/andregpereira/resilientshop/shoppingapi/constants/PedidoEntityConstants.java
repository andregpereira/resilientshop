...
public class PedidoEntityConstants {
    ...
    public static final PedidoEntity PEDIDO_ENTITY = new PedidoEntity(null, PEDIDO_LOCAL_DATE_TIME,
            PEDIDO_LOCAL_DATE_TIME, 1, BigDecimal.valueOf(48), 1L, LISTA_DETALHES_PEDIDO_ENTITY, USUARIO);

    public static final PedidoEntity PEDIDO_ENTITY_MAPEADO = new PedidoEntity(null, null, null, 0, null, 1L,
    ...
    public static final PedidoEntity PEDIDO_ENTITY_ATUALIZADO = new PedidoEntity(null, PEDIDO_LOCAL_DATE_TIME,
            PEDIDO_LOCAL_DATE_TIME, 1, BigDecimal.valueOf(150), 2L, LISTA_DETALHES_PEDIDO_ENTITY_ATUALIZADO, USUARIO);

    public static final PedidoEntity PEDIDO_ENTITY_VAZIO = new PedidoEntity();

    public static final PedidoEntity PEDIDO_ENTITY_INVALIDO = new PedidoEntity(null, null, null, 0, null, null,
