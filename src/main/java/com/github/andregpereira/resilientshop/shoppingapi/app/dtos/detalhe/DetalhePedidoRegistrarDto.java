...
public record DetalhesPedidoRegistrarDto(@NotNull(message = "A quantidade do produto é obrigatória") @Positive(
        message = "Ops! Quantidade inválida, digite um número que não seja negativo ou zero") int quantidade,
        @NotNull(message = "O produto é obrigatório") @Positive(
